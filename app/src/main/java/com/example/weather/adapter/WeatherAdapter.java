...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.ViewHolder> {
    private List<InfoLocationResponse> weatherList;
    ...
    public WeatherAdapter(List<InfoLocationResponse> weatherList, Context context, String checkUpdate) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        InfoLocationResponse weather = weatherList.get(position);
